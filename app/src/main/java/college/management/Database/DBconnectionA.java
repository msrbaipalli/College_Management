...
public class DBconnectionA extends SQLiteOpenHelper {


    public DBconnectionA (Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql="CREATE TABLE marksA (sub1 NUMBER, sub2 NUMBER, sub3 NUMBER);";
        db.execSQL(sql);
    }
    ...
    public void insert(Subjects subMarks) {
        ...
        database.insert("marksA", null, data);
    }
    ...
    public String subjectI() {
        ...
        Cursor cursor= database.rawQuery("SELECT sub1 FROM marksA;", null);
    ...
    public String subjectII() {
        ...
        String sub2= "";
        SQLiteDatabase database= getReadableDatabase();
        Cursor cursor= database.rawQuery("SELECT sub2 FROM marksA;", null);
    ...
    public String subjectIII() {
        ...
        String sub3= "";
        SQLiteDatabase database= getReadableDatabase();
        Cursor cursor= database.rawQuery("SELECT sub3 FROM marksA;", null);
    ...
    public int total() {
        ...
        int ttl= 0;
        SQLiteDatabase database= getReadableDatabase();
        Cursor cursor= database.rawQuery("SELECT * FROM marksA;", null);
