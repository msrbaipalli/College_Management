...
public class DBconnectionB extends SQLiteOpenHelper {


    public DBconnectionB (Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql="CREATE TABLE marksB (sub1 NUMBER, sub2 NUMBER, sub3 NUMBER);";
        db.execSQL(sql);
    }
    ...
    public void insert(Subjects subMarks) {
        ...
        database.insert("marksB", null, data);
    }
    ...
    public String subjectI() {
        ...
        Cursor cursor= database.rawQuery("SELECT sub1 FROM marksB;", null);
    ...
    public String subjectII() {
        ...
        String sub2= "";
        SQLiteDatabase database= getReadableDatabase();
        Cursor cursor= database.rawQuery("SELECT sub2 FROM marksB;", null);
    ...
    public String subjectIII() {
        ...
        String sub3= "";
        SQLiteDatabase database= getReadableDatabase();
        Cursor cursor= database.rawQuery("SELECT sub3 FROM marksB;", null);
    ...
    public int total() {
        ...
        int ttl= 0;
        SQLiteDatabase database= getReadableDatabase();
        Cursor cursor= database.rawQuery("SELECT * FROM marksB;", null);
